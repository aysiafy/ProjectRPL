                            ...
                            <div class="row">
                                <?php if ($detail_absen->absen_masuk != null) : ?>
                                    <div class="col-lg-4 mt-1">
                                        <center>
                                            <img src="<?= base_url('assets/img/pegawai'); ?>/<?= $detail_absen->bukti_masuk; ?>" class="img-thumbnail" alt="">
                                        </center>
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <?php if ($detail_absen->absen_keluar != null) : ?>
                                    <div class="col-lg-4 mt-1">
                                        <center>
                                            <img src="<?= base_url('assets/img/pegawai'); ?>/<?= $detail_absen->bukti_keluar; ?>" class="img-thumbnail" alt="">
                                        </center>
                                    </div>
                                    <div class="col-lg-8 mt-1">
                                        <style>
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item"><span>Absen Pulang: </span><?= date('H:i', $detail_absen->absen_keluar); ?></li>
                                            <li class="list-group-item">
                                                <span>Status Absen: </span>
                                                <span class="badge bg-success">Sukses</span>
                                            </li>
