                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="row gutters">
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                            <img src="<?= base_url(); ?>/assets/img/pegawai/<?= $admin->gambar; ?>" class="img-fluid change-img-avatar" alt="Image">
                                        </div>
                                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12">
                                            <form action="<?= base_url('admin/profile_'); ?>" method="post" enctype="multipart/form-data">
                                                <!-- Field wrapper start -->
                                                <div class="field-wrapper">
                                                    <input type="text" name="nama" class="form-control" value="<?= $admin->nama_admin; ?>" required>
